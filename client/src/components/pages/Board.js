    ...
    <div
      ...
      style={{
        backgroundImage:
          ...
          (board.backgroundURL
            ? board.backgroundURL
            : 'https://images.unsplash.com/photo-1619864896830-3cf3c816a50f?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80') +
          ')',
      }}
    >
      <Navbar />
